...
* @returns {any}
*/
export function send_example_to_js() {
    var ret = wasm.send_example_to_js();
...
* @param {any} val
*/
export function receive_example_from_js(val) {
    try {
        wasm.receive_example_from_js(addBorrowedObject(val));
    } finally {
